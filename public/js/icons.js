...
(function () {
  ...
  var STROKE = {
    ...
    waves: '<path d="M2.5 8.5c1.6-1.6 3.4-1.6 5 0s3.4 1.6 5 0 3.4-1.6 5 0 3.4 1.6 5 0"/><path d="M2.5 14.5c1.6-1.6 3.4-1.6 5 0s3.4 1.6 5 0 3.4-1.6 5 0 3.4 1.6 5 0"/><path d="M2.5 20c1.6-1.6 3.4-1.6 5 0s3.4 1.6 5 0 3.4-1.6 5 0 3.4 1.6 5 0"/>',

    /* Hotel & room amenities */
    bed: '<path d="M3 19.5V7"/><path d="M3 11.5h15a3 3 0 0 1 3 3v5"/><path d="M3 19.5h18"/><path d="M6.5 11.5V9a1.5 1.5 0 0 1 1.5-1.5h5A1.5 1.5 0 0 1 14.5 9v2.5"/><rect x="7.5" y="8.8" width="4" height="2.7" rx="1.2"/>',
    wifi: '<path d="M4.5 9.5a11 11 0 0 1 15 0"/><path d="M7.5 13a7 7 0 0 1 9 0"/><path d="M10.3 16.4a3 3 0 0 1 3.4 0"/><circle cx="12" cy="19.4" r="1" fill="currentColor" stroke="none"/>',
    snow: '<path d="M12 3.5v17"/><path d="M4.5 7.8l15 8.4"/><path d="M19.5 7.8l-15 8.4"/><path d="M12 7.2 9.6 5.2M12 7.2l2.4-2M12 16.8l-2.4 2M12 16.8l2.4 2"/>',
    droplet: '<path d="M12 3.5s5.5 6 5.5 9.8A5.5 5.5 0 0 1 6.5 13.3C6.5 9.5 12 3.5 12 3.5Z"/>',
    bath: '<path d="M3 12.5h18"/><path d="M4.5 12.5v3.8A3.2 3.2 0 0 0 7.7 19.5h8.6a3.2 3.2 0 0 0 3.2-3.2v-3.8"/><path d="M7.5 19.5V21M16.5 19.5V21"/><path d="M7.5 12.5V6.8a2.3 2.3 0 0 1 4.4-.9"/>',
    tv: '<rect x="3" y="5" width="18" height="11.5" rx="2.2"/><path d="M8.5 20h7"/><path d="M12 16.5V20"/>',
    fan: '<circle cx="12" cy="12" r="2"/><path d="M12 10c0-3.2.8-5.5 3-5.5 1.7 0 2.6 1.4 2 3-.6 1.6-2.4 2.5-5 2.5Z"/><path d="M13.7 13c2.8 1.6 4.3 3.4 3.2 5.3-.9 1.5-2.5 1.5-3.6.3-1.1-1.2-1.2-3.2.4-5.6Z"/><path d="M10.3 13c-2.8 1.6-4.6 1.8-5.6.1-.8-1.5 0-2.9 1.6-3.1 1.6-.2 3.2.9 4 3Z"/>',
    hanger: '<path d="M12 7.5a2 2 0 1 1 2-2"/><path d="M12 7.5v2.2L3.8 15a1.4 1.4 0 0 0 .8 2.6h14.8a1.4 1.4 0 0 0 .8-2.6L12 9.7"/>',
    ...
    /* Dine-In: fork & knife */
    dine: '<path d="M7 3.5v5.4a2.3 2.3 0 0 0 4.6 0V3.5"/><path d="M9.3 3.5v5.4"/><path d="M9.3 11.2V20.5"/><path d="M15.8 20.5V3.5c2.3 1.6 3.3 4.2 3.3 7.1 0 1.9-1.1 3.1-3.3 3.4"/>',
  };

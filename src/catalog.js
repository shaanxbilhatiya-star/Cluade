...
const EXPERIENCES = [
  ...
  },
  {
    ...
    features: [
      '02 Halls',
      '500 लोगों के लिए डाइनिंग',
      'वेडिंग लाइट्स, स्टेज, मंडप, पंडाल',
      'कर्मचारियों का प्रबंध (सेवक, किचन, स्टाफ)',
    ],
    badge: 'Economy',
    order: 7,
  },
  {
    ...
    title: 'Wedding – Economy Plus (1 Day)',
    category: 'Wedding',
    ...
    priceNote: 'for 1 Day · Economy Package',
    features: [
      '05 Halls (स्टेज + डांस + लॉबी)',
      '500 लोगों के लिए डाइनिंग',
      'स्क्रीन, साउंड सिस्टम (22 इंच 100 लोगों के लिए)',
      'डेकोरेशन (फूल, लाइट, स्टेज, मंडप)',
      'कर्मचारियों का प्रबंध (सेवक, किचन, स्टाफ)',
    ],
    badge: 'Economy',
    order: 8,
  },
  {
    ...
    features: [
      '15 Halls (स्टेज + 15 कॉन्फेंस)',
      '1 वीआयपी वेडिंग थीम सेटअप',
      '100 लोगों के लिए ब्रेकफास्ट एवं लंच',
      '500 लोगों के लिए डिनर (विशेष मेनू सहित)',
      'डेकोरेशन (मुड्रित, साइंड, लाइट 100 कॉन्फेंस)',
      'ड्रो-वेटिंग',
      'झड़ई-वेटिंग (सजावट, हल्दी एवं मेहंदी फंक्शन)',
      'स्टाफ (सेक्योरिटी, भोजन, सर्विस)',
      'जनरेटर एवं टी.वी. कनेक्शन',
    ],
    badge: 'Premium',
    order: 9,
  },
  {
    ...
    features: [
      '15 Halls (स्टेज + 15 कॉन्टेंग + स.सी. हॉल एवं लॉन)',
      '100 लोगों के लिए ब्रेकफास्ट एवं डिनर (पूरे 2 दिन)',
      'झावियांग की समारोट (1 रात 100 लोगों के लिए)',
      '100 लोगों के लिए ब्रेकफास्ट एवं स्नेक्स (दूसरे दिन)',
      '500 लोगों के लिए डिनर (विशेष मेनू सहित)',
      'डेकोरेशन (फूल सजावट, लाइटिंग एवं स्टेज)',
      '70×12 डेजन प्रांउंड रूम, पार्किंग स्पेस, लोकीलोइंव',
      'स्टाफ, सुरक्षा, भोजन बाजाय, सर्किस स्टाफ',
      'जनरेटर एवं टी.वी. कनेक्शन',
    ],
    badge: 'Grand',
    order: 10,
